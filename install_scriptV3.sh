...
# Add the VGMPlay player script
echo "Adding VGMPlay player script..."
...
# Add the MOC player script
echo "Adding MOC player script..."
...
# Make the scripts executable and change the ownership
echo "Making the scripts executable and changing ownership..."
